...
| `t4` | Split a $100.00 shared utility bill evenly across 3 departments (cash paid). | ❌ UNBALANCED |
| `t5` | Buy a $2,500 laptop with cash (capitalize as equipment). | ❌ UNBALANCED |
