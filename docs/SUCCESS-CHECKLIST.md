...
- For non-trivial logic emit `CanonicalFinancialArtifact` (scope, assumptions, citations, kernelPlan referencing the primitives, proof, reproducibility). Use `makeCanonicalArtifact`.
