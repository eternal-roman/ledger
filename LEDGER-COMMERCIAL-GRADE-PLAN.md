...
**Status (v0.4.0)**: Kernel complete (Money div/allocate/compare exact, FX, provenance). Ledger audit/snapshot/replay. Basic CFA. GAAP + IFRS seeds. 51 tests, verify:full green. MCP-enforced releases + CI.
