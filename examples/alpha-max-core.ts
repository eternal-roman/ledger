/**
 * End-to-end demonstration of the new Alpha-Max core features:
 * Period Lock (hard close), Closing to RE, FX Translation + CTA, Depreciation schedules.
 *
 * Every monetary operation and entry uses the kernel primitives.
 * All generated entries are validated + equation proven.
 */
...
async function main() {
  ...
  // CFA for the dep schedule (per plan)
  ...
  console.log('\nAll Alpha-Max core features exercised with kernel invariants.');
}
